...
private Pokemon crearPokemon(String nombre) {
    ...
    private void cargarEquipoCpu(Jugador cpu) {
        ...
        boolean squirtle = false;
        boolean pidgey = false;
        boolean pikachu = false;
        boolean sandshrew = false;
        boolean diglett = false;
        boolean ponyta = false;
        boolean psyduck = false;
        boolean spearow = false;
        boolean jolteon = false;
        ...
        while (cantidad < 4) {
            ...
            switch (opcion) {
                case 0:
                    if (!charmander) {
                        pokemon = crearPokemon("Charmander");
                        charmander = true;
                    }
                    break;
                case 1:
                    if (!squirtle) {
                        pokemon = crearPokemon("Squirtle");
                        squirtle = true;
                    }
                    break;
                case 2:
                    if (!pidgey) {
                        pokemon = crearPokemon("Pidgey");
                        pidgey = true;
                    }
                    break;
                case 3:
                    if (!pikachu) {
                        pokemon = crearPokemon("Pikachu");
                        pikachu = true;
                    }
                    break;
                case 4:
                    if (!sandshrew) {
                        pokemon = crearPokemon("Sandshrew");
                        sandshrew = true;
                    }
                    break;
                case 5:
                    if (!diglett) {
                        pokemon = crearPokemon("Diglett");
                        diglett = true;
                    }
                    break;
                case 6:
                    if (!ponyta) {
                        pokemon = crearPokemon("Ponyta");
                        ponyta = true;
                    }
                    break;
                case 7:
                    if (!psyduck) {
                        pokemon = crearPokemon("Psyduck");
                        psyduck = true;
                    }
                    break;
                case 8:
                    if (!spearow) {
                        pokemon = crearPokemon("Spearow");
                        spearow = true;
                    }
                    break;
                case 9:
                    if (!jolteon) {
                        pokemon = crearPokemon("Jolteon");
                        jolteon = true;
                    }
                    break;
            }
...
<<<<<<< HEAD
        ...
        cbPokemon3.addActionListener(this::cbPokemon3ActionPerformed);
        ...
        cbPokemon2.addActionListener(this::cbPokemon2ActionPerformed);
...
<<<<<<< HEAD
        ...
        if (p1.equals(p2) || p1.equals(p3) || p1.equals(p4)
                ...
                || p3.equals(p4)) {
            JOptionPane.showMessageDialog(this, "No puede repetir Pokémon.");
            return;
        }
        ...
        jugador.agregarPokemon(crearPokemon(p1));
        jugador.agregarPokemon(crearPokemon(p2));
        jugador.agregarPokemon(crearPokemon(p3));
        jugador.agregarPokemon(crearPokemon(p4));
